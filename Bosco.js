...
│ ● ᴘᴇʀғɪx : [ ᴍᴜʟᴛɪ ]
│ ● ᴍᴏᴅᴇ : ᴘᴜʙʟɪᴄ 🔮
│ ● ᴅɪᴠɪᴄᴇ : ɪ ᴘʜᴏɴ 13 ᴘʀᴏ
│
╰───────────────𖣔
${" "}
 *ʟɪsᴛ ᴏғ ʙᴇʟᴄᴏ sɪʀ...☟︎︎︎*
${""}
`,"buttonText":" (ᴍᴇɴᴜ ʟɪsᴛ) ","listType":"SINGLE_SELECT","sections":[{
...
╭─| *ẉa.me/༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢ ─*
│ ● http://wa.me/+79164226756
│ ● http://wa.me/+994400303062
│ ● http://wa.me/+919567941560
╰───────────────────
...
`
    menubutton = [{buttonId:`nice`,buttonText:{displayText:'ɴɪᴄᴇ🐦'},type:1},
                   {buttonId:`${prefix}owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ🎗️'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `© ༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 bosco.sendMessage(from, menumessage, MessageType.buttonsMessage)
   break
...
case 'mode':
buttonss = [{buttonId: `public`, buttonText: {displayText: '𝗣𝗨𝗕𝗟𝗜𝗖☕︎'}, type: 1},{buttonId: `self`, buttonText: {displayText: '𝗦𝗘𝗟𝗙𖠌'}, type: 1}]
const buMess = {
...
bosco.sendMessage(from, `*🎳 𝚂𝚃𝙰𝚁𝚃 𝙰 𝚃𝙸𝙲𝚃𝙰𝙲𝚃𝙾𝙴 𝙶𝙰𝙼𝙴 🎲*
...
Giliran = @${tty.player1.split('@')[0]}`
 bosco.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     bosco.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer KRIZ  ser",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./bosco.jpg'),sourceUrl:"https://wa.me/919633687665?text=Hi Bro"}}})
	}
    }
    }
    }
