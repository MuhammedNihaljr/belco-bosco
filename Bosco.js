...
module.exports = bosco = async (bosco, mek) => {
	try {
		...
		const catl = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 400, "message": teks, "footerText": "*Belco Ser*", "thumbnail": dfrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             bosco.relayWAMessage(res)
        }
       const catlo = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 70000, "message": teks, "footerText": "Made With Belco Ser", thumbnail: fs.readFileSync('./ds.jpg'), "surface": 'CATALOG' }}, {quoted:mek})
             bosco.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = bosco.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'ʜʏ ᴅᴜᴅᴇ...☕︎', "groupName": `Bosco Family`, "footerText": "*Belco Ser*", "jpegThumbnail": dfrply, "caption": teks}}, {quoted:fvideo})
        ...
        const reply = (teks) => {
	      bosco.sendMessage(from, teks, text, { thumbnail: denis, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, "externalAdReply": { "title": `${' '}༱༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢࿏༢${''}${''}`, "body": `Gʀᴏᴜᴘ Assɪsᴛᴇɴᴛ Bᴏᴛ`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}},})
        }
...
/}*/
        ...
        //FAKEREPLY PRODUCT
            ...
            //FAKE VN
            const fvn = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "919567941560@s.whatsapp.net" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds": "359996400","ptt": "true"}}}
            //FAKE TEXT
            const ftext = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "919567941560@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `▢ ${fake} ▢`,"title": `Hmm`,'jpegThumbnail': denis}}}
            //FAKE LIVE ACTION
            const floc2 = {
                  key: {"fromMe": false,"participant": `0@s.whatsapp.net`, "remoteJid": "919567941560-1621036495@g.us" },message: { "liveLocationMessage": { "title":`${fake}`,}}}
            //FAKEREPLY TROLI
            const ftroli = {
            ...
            //FAKEREPLY VIDEO
            const fvideo = {
                  key: {fromMe: false,participant: `62895619083555@s.whatsapp.net`, ...(from ? { remoteJid: "919567941560@s.whatsapp.net" } : {}) },message: { "videoMessage": { "title":"fake","h": `Hmm`,'seconds': '359996400', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./life.jpg')}}}
...
const ftrol = {
	key : {
       ...
       message: {
        ...
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '919567941560@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:mADE With Belco\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/Nakano.jpg')
        }}}
       const math = (teks) => {
...
// AUTO
			...
			for (let anjh of imagi){
				if (budy === anjh){
					...
					bosco.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 500, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `${fake}`, orderTitle: `ʙᴇʟᴄᴏ sᴇʀ ᴏғᴄ`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
      ...
      const sendWebp = async(to, url) => {
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           bosco.sendMessage(to, media, type, {quoted: mek, "externalAdReply": { "title": `${' '}༱༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢࿏༢${''}${''}`, "body": `Gʀᴏᴜᴘ Assɪsᴛᴇɴᴛ Bᴏᴛ`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
      ...
      const sendFileFromUrl = async(link, type, options) => {
          ...
          if (!packname) packname = '!Belco'; if (!author) author = 'Ser';author = author.replace(/[^a-zA-Z0-9]/g, '');	
...
// Anti link
       ...
       if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
        ...
        if (isCmd && isGroup)
            ...
            case 'owner':
            ini_ownerNumber = [`${setting.owner}@s.whatsapp.net`,`919567941560@s.whatsapp.net`,`919567941560@s.whatsapp.net`,`${setting.owner}@s.whatsapp.net`,`${setting.owner}@s.whatsapp.net`]
            let ini_list = []
 ...
 hehe = `┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┓ 
      *☆ ~𝙸𝚃𝚂𝙼𝙴 𝙱𝙴𝙻𝙲𝙾~ ☆*
┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┛ 
 ❏ʜɪ ʙʀᴏ @${sender.split("@")[0]}
┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┓ 
┣
┣▢ *ᴏᴡɴᴇʀ* : _ɴɪʜᴀʟ ♔︎_
┣▢ *ᴄʀᴇᴀᴛᴏʀ* : @919567941560
┣▢ *ᴠᴇʀsɪᴏɴ* : 2.0 
┣▢ *ᴍᴏᴅᴇ* : ᴘᴜʙʟɪᴄ 
┣▢ *ᴘʀᴇғɪx* : [ . ] 
┣
┣         ⁂ *𝙸𝙽𝙵𝙾* ⁂
┣
┣❄︎ *ɴᴀᴍᴇ* : ⁱᵗˢᵐᵉᗷᗴᒪᑕO𝓼𝓮𝓻♔︎¹⁰
┣❄︎ *ᴘʀɪᴠᴀᴛᴇ* : ${privat.length}
┣❄︎ *ɢʀᴏᴜᴘs* : ${groups.length}
┣❄︎ *ᴛᴏᴛᴀʟ* : ${totalChat.length}
┣❄︎ *sᴘᴇᴇᴅ* : ${latensie.toFixed(4)}
┣❄︎ *ʙᴀᴛᴛᴇʀʏ* : uncnoun%\n
┣
┣        ▎▍▌▌▉▏▎▌▉▐▏▌▎
┣        ▎▍▌▌▉▏▎▌▉▐▏▌▎ 
...
┣
┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┛   
 ❏    *ᵘˢᵉ ᵗʰᵉ ᵇᵘᵗᵗᵒⁿ ᵃⁿᵈ ᵉⁿʲᵒʸ*     ❏
${jmn} -  ${jmo}\n${week} - ${calender}
┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┓ 
           ◩ *♥︎𝚃𝙷𝙰𝙽𝙺𝚂♥︎* ◪ 
┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍┛
 `
 menubutton = [{buttonId:`${prefix}menu`,buttonText:{displayText:'ɴᴇxᴛ☕︎'},type:1},
 {buttonId:`${prefix}owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ𖠌'},type:1},
]
...
│ 
│ ✌︎ ᴄʀᴇᴀᴛᴏʀ : ɴɪʜᴀʟ ♔︎
│ ✌︎ ᴏᴡɴᴇʀ : @919567941560
│ 
│ ✌︎ ᴘᴇʀғɪx : [ ᴍᴜʟᴛɪ ]
│ ✌︎ ᴍᴏᴅᴇ : ᴘᴜʙʟɪᴄ 🔮
│ ✌︎ ᴅɪᴠɪᴄᴇ : ɪ ᴘʜᴏɴ 13 ᴘʀᴏ
│
╰───────────────𖣔
${" "}
 *ʟɪsᴛ ᴏғ ʙᴇʟᴄᴏ sɪʀ...☟︎︎︎*
${""}
`,"buttonText":" ᴍᴇɴᴜ ʟɪsᴛ 𖠌 ","listType":"SINGLE_SELECT","sections":[{
"title":"sᴇʟᴇᴄᴛ ᴏɴᴇ🤖","rows":[{
'title':'DONATE\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'donate'
}
,{'title':'OWNER\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'ownermenu'}
,{'title':'GROUP\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'groupmenu'}
,{'title':'EDIT\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'editmenu'}
,{'title':'STORAGE\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'storagemenu'}
,{'title':'EXTRA\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'extramenu'}
,{'title':'DOWNLOAD\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'downloadmenu'}
,{'title':'DEVOLEPER\x20INFO\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'developerinfo'}
,{'title':'HELP\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'belco2'}
,{'title':'OWNER\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'owner'}
,{'title':'DOWNLOAD\x20MENU\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'downloadmenu'}
,{'title':'CREDITS\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'credits'}
,{'title':'PING\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'ping'}
,{'title':'RULES\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'rules'}
,{'title':'SLOT\x0aʙʏ\x20ʙᴇʟᴄᴏ-sᴇʀ🖤','description':'','rowId':prefix+'slot'}
]}]}},{});bosco.relayWAMessage(pi,{waitForAck:true})

break
    
    case 'boscogroup':
     function _0x4663(){var _0x2fc8bc=['61360RbdMuw','1938303OzLjeN','659960nzjTUM','404766EJGGBI','7WhscAJ','997400vvejgD','1297674CcBmhI','610998dTuyrA','5IPhDWS'];_0x4663=function(){return _0x2fc8bc;};return _0x4663();}function _0x1231(_0x40cb45,_0x55ff98){var _0x4663dc=_0x4663();return _0x1231=function(_0x1231ee,_0x440ba1){_0x1231ee=_0x1231ee-0x166;var _0x2eb6a7=_0x4663dc[_0x1231ee];return _0x2eb6a7;},_0x1231(_0x40cb45,_0x55ff98);}(function(_0x4d6264,_0xc43f28){var _0x4f3c9d=_0x1231,_0xf81e96=_0x4d6264();while(!![]){try{var _0x15833d=parseInt(_0x4f3c9d(0x16b))/0x1+-parseInt(_0x4f3c9d(0x16e))/0x2+-parseInt(_0x4f3c9d(0x169))/0x3+-parseInt(_0x4f3c9d(0x16d))/0x4*(-parseInt(_0x4f3c9d(0x16a))/0x5)+parseInt(_0x4f3c9d(0x168))/0x6+-parseInt(_0x4f3c9d(0x166))/0x7*(parseInt(_0x4f3c9d(0x167))/0x8)+parseInt(_0x4f3c9d(0x16c))/0x9;if(_0x15833d===_0xc43f28)break;else _0xf81e96['push'](_0xf81e96['shift']());}catch(_0x375167){_0xf81e96['push'](_0xf81e96['shift']());}}}(_0x4663,0x1f128),groupBot='ʜʏ ᴅᴜᴅᴇ....☕︎',catlo(groupBot));
    break
    case 'ownermenu':
    bosco1 = await bosco.prepareMessage(from, denis, location, {thumbnail: denis})
              bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
...
`
 ...
 menumessage = { contentText: `${teks}`, footerText: `© ༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
...
`
    menubutton = [{buttonId:`nice`,buttonText:{displayText:'ɴɪᴄᴇ🤖'},type:1},
                   {buttonId:`${prefix}donate`,buttonText:{displayText:'ᴅᴏɴᴀᴛᴇ🔮︎'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `© ༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 bosco.sendMessage(from, menumessage, MessageType.buttonsMessage)
   break
...
╰────────────────𖣔
` 
menubutton = [{buttonId:`nice`,buttonText:{displayText:'ɴɪᴄᴇ🤖︎'},type:1},
                   {buttonId:`${prefix}donate`,buttonText:{displayText:'ᴅᴏɴᴀᴛᴇ🔮︎'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `© ༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 bosco.sendMessage(from, menumessage, MessageType.buttonsMessage)
 ...
 *☆ ᴀɴʏ ᴘʀᴏʙʟᴇᴍs ᴄᴏɴᴛᴇᴄᴛ ᴏɴ☟︎︎︎*

╭─| *ẉa.me/༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢ ─*
│ ✌︎ http://wa.me/+79164226756
│ ✌︎ http://wa.me/+994400303062
│ ✌︎ http://wa.me/+919567941560
╰───────────────────
...
5. 𝙰𝙽𝚈 𝙿𝚁𝙾𝙱𝙻𝙰𝙼 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 *𝙱𝙴𝙻𝙲𝙾 𝚂𝙸𝚁♔︎*

𝙾𝚆𝙽𝙾𝚁 : wa.me/919567941560`
...
`
    menubutton = [{buttonId:`nice`,buttonText:{displayText:'ɴɪᴄᴇ🐦'},type:1},
                   {buttonId:`${prefix}donate`,buttonText:{displayText:'ᴅᴏɴᴀᴛᴇ🎗️'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `© ༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 bosco.sendMessage(from, menumessage, MessageType.buttonsMessage)
   break
 ...
 *☞︎︎︎ ɴᴀʏᴀ ᴘᴀɪsᴀ ɪʟʟᴀᴛʜᴀ ɴᴇᴇ ᴏᴋᴋᴇ ɴᴛʜɪɴᴀᴅᴀ ᴅᴏɴᴀᴛᴇ ᴋʟɪᴄᴋ ᴄʜᴇʏʏᴜɴɴᴇ...🥵*
 
 *⚠︎ ɪᴛs ᴠᴇʟᴀᴄʜɪʟ...😑*
 
╭───────────────᪥
│♔︎ ᴀɴᴛʜᴀᴅᴀ ғᴇᴀʀ ᴀʏᴏ ɴɪʏʏ😩
╰───────────────᪥
`
    menubutton = [{buttonId:`nice`,buttonText:{displayText:'ɴɪᴄᴇ🤖'},type:1},
                   {buttonId:`${prefix}owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ🔮︎'},type:1}
...
//------------------< Bot Owner >-------------------
       ...
       case 'group':
        rows = [
          ...
          section = [{title: "༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢𝓼𝓮𝓻♔︎", rows: rows}]
...
const btnbc = {
    ...
    footerText: '*ʙʀᴏᴀᴅᴄᴀsᴛ ʙʏ _ʙᴇʟᴄᴏ sᴇʀ ♔︎_*',
    buttons: buttonss,
    headerType: 1
}
            ...
            case 'tobc':
					...
					buff = await bosco.downloadMediaMessage(encmedia)
					for (let _ of anu) {
					bosco.sendMessage(_.jid, buff, gif, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 101010, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `𝑬𝑽𝑬𝑹𝒀𝑻𝑯𝑰𝑵𝑲\n𝑾𝑰𝑳𝑳 𝑩𝑬\n😎𝑶𝑲😎`, orderTitle: `ʙʀᴏᴀᴅᴄᴀsᴛ`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 22, isForwarded: true}})
					}
					} else {
...
break
        case 'exif':
             if (args.length == 0) return reply(`Ex:- ${prefix}exif Belco Ser`)
             if (!isOwner) return  reply(mess.only.owner)
...
case 'mode':
buttonss = [{buttonId: `public`, buttonText: {displayText: 'ᴘᴜʙʟɪᴄ🐦︎'}, type: 1},{buttonId: `self`, buttonText: {displayText: 'sᴇʟғ🤖'}, type: 1}]
const buMess = {
    contentText: "*🅂🄴🄻🄵/🅿︎🆄︎🅱︎🅻︎🅸︎🅲*︎",
    footerText: '𝙲𝙷𝙾𝙸𝙲𝙴 𝙰𝙽𝚈𝙾𝙽𝙴 𝚅𝚁𝙾..!',
    buttons: buttonss,
    headerType: 1
}
...
//------------------< Downloader/And Search Media >-------------------
      ...
      case 'more':
       ...
       case 'pinterest':
         case 'pin':
              if (args.length < 1) return reply(`${prefix}Belco Ser`)
...
╰───────────────❋۪۪
 ⌕𖨆𖨆 ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙
╭◪ ᴄᴏᴅᴇᴅ ʙʏ : *ī.am/ʙᴇʟᴄᴏ sɪʀ*
╰────────────────❋۪۪
`
    menubutton = [{buttonId:`${prefix}credits`,buttonText:{displayText:'ᴄʀᴇᴅɪᴛs♡︎'},type:1},
                   {buttonId:`${prefix}owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ♔︎'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `© ༱ⁱᵗˢᵐᵉʙᴇʟᴄᴏ࿏༢`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 bosco.sendMessage(from, menumessage, MessageType.buttonsMessage)
 ...
 //------------------< Extra >-------------------
      ...
      case 'tod':
        ...
        case 'anime':
              ...
              imageMsg = ( await bosco.prepareMessage(from, fs.readFileSync(`./${sender}.jpeg`), 'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
              buttonsMessage = {footerText:'© ʙᴇʟᴄᴏ sᴇʀ ᴏғᴄ', imageMessage: imageMsg,
...
▢ᴘᴜʙʟɪᴄᴀᴛɪᴏɴ : ${res.all[0].ago}
▢ᴡᴀᴛᴄʜᴇᴅ : ${res.all[0].views}
▢ᴅᴜʀᴀᴛɪᴏɴ : ${res.all[0].timestamp}
▢ᴄʜᴀɴɴᴇʟ : ${res.all[0].author.name}
...
//------------------< Storage >-------------------
      ...
      case 'addbgm':
					...
					bosco.sendMessage(from, `*sᴇᴄᴄᴜss ғᴜʟʟʏ ᴀᴅᴅᴇᴅ ʙɢᴍ ᴛᴏ ʙᴇʟᴄᴏ sᴇʀ*`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {})}, message: { orderMessage: { itemCount: 333, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `${nm}`, orderTitle: 'hehe', sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
					break
	 case 'delvn':
	                if (!isOwner) return 
					try {
				...
				case 'listbgm':
					...
					teks += `\n*ᴛᴏᴛᴀʟ : ${vien.length}*\n\n_▢_`
					bosco.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}𝒂𝒎ʙᴇʟᴄᴏ${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://i.ibb.co/vkkcm0L/034c588fd8d5.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/919567941560'}`}},quoted: ftext})
					break
				case 'addimage':
				    if (!isOwner) return
	...
	if (!Number(oi2)) return reply('*The number must be a number!*')
     ...
     case 'tagme':
				...
				if (!isOwner) return 
					...
					if (err) return bosco.sendMessage(from, `root @Belco Ser:~ ${err}`, text, { quoted: mek })
                 break
              case 'swm':
