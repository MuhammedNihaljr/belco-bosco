...
"listMessage":{
"title":"ʜʏ ᴍᴀɴ  ${pushname} ","description":`${""}   
...
,{'title':'OWNER\x20MENU\x0aOwmer\x20Cmnds','description':'','rowId':prefix+'ownermenu'}
...
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❙❚❙❘❙❙❘❙❚❙➪ᴀᴍ ʙᴇʟᴄᴏ♔︎
`
    menubutton = [{buttonId:`nice`,buttonText:{displayText:'𝗡𝗜𝗖𝗘🐦'},type:1},
                   {buttonId:`${prefix}owner`,buttonText:{displayText:'𝗢𝗪𝗡𝗘𝗥🎗️'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `©ⁱᵗˢᵐᵉᗷᗴᒪᑕO𝓼𝓮𝓻♔︎¹⁰`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 bosco.sendMessage(from, menumessage, MessageType.buttonsMessage)
   break
