...
▢♔︎ ${prefix}readall
`
menubutton = [{buttonId:`owner`,buttonText:{displayText:'𝗢𝗪𝗡𝗘𝗥☕︎'},type:1}
]
   break
   case 'groupmenu':
      group1 = `
...
`
    menubutton = [{buttonId:`${prefix}credits`,buttonText:{displayText:'𝗖𝗥𝗘𝗗𝗜𝗧𝗦♔︎'},type:1},
                   {buttonId:`${prefix}owner`,buttonText:{displayText:'𝗢𝗪𝗡𝗘𝗥𖠌'},type:1}
]
